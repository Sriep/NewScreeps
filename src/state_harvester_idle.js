...
StateHarvesterIdle.prototype.nextFreeHarvesterPost = function (colonies) {
    ...
    for (let colony of colonies) {
        ...
        for (let sourceId in colonyInfo.getSources()) {
            ...
            //});
            //console.log("nextFreeHarvesterPost h at sourceid", sourceId,"number", hAt.length, "objs", JSON.stringify(hAt));
        ...
        for (let harvester of harvesters) {
            ...
            //console.log("harvester", harvester,"posts", JSON.stringify(posts));
