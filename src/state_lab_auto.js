...
function StateLabAuto (structure) {
    this.type = gc.STATE_LAB_AUTO;
    this.lab = structure;
}

StateLabAuto.prototype.enact = function () {
...
StateLabAuto.prototype.makeResource = function (resource) {
...
StateLabAuto.prototype.findReactionToMake = function(resource) {
...
StateLabAuto.prototype.findLabWith = function(resource, lab) {
...
StateLabAuto.prototype.labsMineral = function(store) {
...
StateLabAuto.prototype.emptyLab = function () {
